...
# Read data
# ------------------------------------------------------
file='C:/Users/Mark Dekker/OneDrive/Data/MAIO_Project/Mercator_2h_august_18_september_7.nc'
...
imobj=plt.imshow(data, cmap=my_cmap, animated=True, extent=[-65,-60,17,18],aspect=2)

plt.colorbar(orientation='horizontal')
plt.clim(301.5,303.5)
time_text = plt.text(-65,18, '', zorder=10)

Quivers=plt.quiver(lon2,lat2,U,V,units='inches',scale=0.3,pivot='tip',width=0.015)#units='x',pivot='tip',width=0.008,scale=1 / 0.5)
qk = plt.quiverkey(Quivers, 0.5, 1.03, 0.5, r'$0.5 \frac{m}{s}$', labelpos='W',
                   fontproperties={'weight': 'bold'})
